...
function getPosition(res1){
    ...
    function ajaxData() {
        if (!stopSignal) {
            //var data = [{ imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" }];
            $.ajax({
    ...
    function pagePreLoad() {
         $.ajax({
                ...
                success: function(data) {
        //var data = [{ imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" },
        //            { imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" },
        //            { imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" },
        //{ imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" },
        //            { imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" },
        //            { imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" },
        ...
        //            { imgUrl: "/Themes/GSK.WeChat.Frontend/Content/avatar/a003.jpg", name: "了了" }, ];
                     if (data != "") {
                         $.each(data, function (t) {
                             ...
                             $('#ready' + (t + 1)).find('img').attr('src', data[t].imgUrl);
                         });
                     }
                     ajaxData();
                 }
